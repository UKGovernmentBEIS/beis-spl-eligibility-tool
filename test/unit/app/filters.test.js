...
describe('filters', () => {
  ...
  describe('hasCheckedAnyEligiblity', () => {
    ...
    // it('returns true if parent is primary and eligibility is not unknown', () => {
    //   filters = require('../../../app/filters')(environment)
    ...
    //   const result = filters.hasCheckedAnyEligibility(data, 'primary')
    //   expect(result).to.equal(true)
    // })

    // it('returns true if parent is secondary and eligibility is not unknown', () => {
    //   filters = require('../../../app/filters')(environment)
    ...
    //   const result = filters.hasCheckedAnyEligibility(data, 'secondary')
    //   expect(result).to.equal(true)
    // })

    // it('returns false if there is no employment status', () => {
    //   filters = require('../../../app/filters')(environment)
    ...
    // it('returns false if there is an undefined continuous work value', () => {
    //   filters = require('../../../app/filters')(environment)
